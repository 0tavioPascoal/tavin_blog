...
export function AdminShell({ user, children }: AdminShellProps) {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      >
        <header className="sticky top-0 z-40 border-b border-slate-300/70 bg-card/90 px-6 py-4 backdrop-blur-xl dark:border-slate-800 lg:hidden">
        ...
        <main className="mx-auto w-full max-w-screen-2xl px-6 py-8 sm:px-8 lg:px-10">
          {children}
        </main>
      </div>
    </div>
